  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-background">
      <div className="form-wrapper max-w-2xl">
        <div className="mb-8">
          <h1 className="font-bold text-2xl text-center mb-4 text-text">About Collective</h1>
        ...
        <div className="mb-8">
          <h2 className="font-bold text-xl text-center mb-2 text-text">Authors</h2>
          <p className="text-text leading-relaxed text-center">Nicole Blanchette, Epifania Garcia, Alexa Leoto</p>
        </div>
        <div className="mb-8">
          <h2 className="font-bold text-xl text-center mb-2 text-text">Mission</h2>
        ...
        <div className="mb-8">
          <h2 className="font-bold text-xl text-center mb-2 text-text">Problem</h2>
          <p className="text-text leading-relaxed">
          ...
          <h3 className="font-bold text-lg text-center mt-4 mb-2 text-text">Inadequate Solutions and Market Gaps</h3>
          <p className="text-text leading-relaxed">
        ...
        <div className="mb-8">
          <h2 className="font-bold text-xl text-center mb-2 text-text">Summary</h2>
