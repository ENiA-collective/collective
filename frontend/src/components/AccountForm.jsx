...
const AccountForm = ({ handleSubmit, formData, setFormData }) => {
  ...
  return (
    <div className="max-w-xs bg-blue-50 overflow-hidden rounded-2xl text-black">
      <form
      ...
      >
        ...
        <button
          type="submit"
          className="bg-black text-white rounded-full font-semibold text-lg px-6 py-3 cursor-pointer transition-all duration-300 ease-in-out border border-black shadow-none hover:-translate-y-1 hover:-translate-x-0.5 hover:shadow-[2px_5px_0_0_black] active:translate-y-0.5 active:translate-x-0.25 active:shadow-none"
        >
          Submit
        </button>
      </form>
